        ...
        success: function (data) {
            if (data.code == 100) {
                ...
                for (var i in info_list) {
                    ...
                    if (language == 2) {
                        str += "<li class=\"w5\"><a href=\"FaBiJiaoYi-Wygm-2.html?pid=" + sell_info.pid + "\" class=\"btn btn-success\">purchase" + currency_name + "</a></li>";
                    } else {
                        str += "<li class=\"w5\"><a href=\"FaBiJiaoYi-Wygm-2.html?pid=" + sell_info.pid + "\" class=\"btn btn-success\">购买" + currency_name + "</a></li>";
                    }
                    str += "</ul> </li>";
                }
                $("#sell_info").html(str);
